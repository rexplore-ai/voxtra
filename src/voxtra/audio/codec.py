"""Audio codec conversion helpers for telephony audio formats.

Provides pure-Python μ-law and A-law codec conversion without
external dependencies. These are the standard codecs used in
telephony (G.711).
"""
...
# ---------------------------------------------------------------------------
# A-law (G.711 A-law) — standard in Europe
# ---------------------------------------------------------------------------
